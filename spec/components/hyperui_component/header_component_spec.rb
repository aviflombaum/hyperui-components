...
RSpec.describe(HyperuiComponent::HeaderComponent, type: :component) do
  before do
    allow_any_instance_of(HyperuiComponent::HeaderComponent::NavigationItem).to(
  ...
  subject! { render_inline(HyperuiComponent::HeaderComponent.new(**kwargs)) }
  ...
  context 'when the logo is overwritten' do
    ...
    subject! do
      render_inline(HyperuiComponent::HeaderComponent.new) do |component|
  ...
  describe 'navigation menus' do
    ...
    context 'when navigation items are supplied' do
      ...
      subject! do
        ...
        render_inline(HyperuiComponent::HeaderComponent.new(**header_kwargs)) do |component|
      ...
      describe 'menu button (for mobile)' do
        ...
        context 'when the menu button label is overriden' do
          ...
          subject! do
            render_inline(HyperuiComponent::HeaderComponent.new(**kwargs.merge(menu_button_label: custom_label))) do |component|
      ...
      context 'when the navigation label is overriden' do
        ...
        subject! do
          render_inline(HyperuiComponent::HeaderComponent.new(**kwargs.merge(navigation_label: custom_label))) do |component|
            navigation_items.each { |item| component.navigation_item(**item) }
          end
        end
