...
RSpec.describe HyperuiComponent::SectionBreakComponent, type: :component do
  ...
  context "when visible is true" do
    it "renders the section break with the visible class" do
      component = HyperuiComponent::SectionBreakComponent.new(visible: true)
  ...
  context "when visible is false" do
    it "renders the section break without the visible class" do
      component = HyperuiComponent::SectionBreakComponent.new(visible: false)
  ...
  context "when size is blank" do
    it "renders the section break without the size class" do
      component = HyperuiComponent::SectionBreakComponent.new
  ...
  context "when size is valid" do
    it "renders the section break with the size class" do
      component = HyperuiComponent::SectionBreakComponent.new(size: "xl")
  ...
  context "when size is invalid" do
    let(:component) { HyperuiComponent::SectionBreakComponent.new(size: "s") }
