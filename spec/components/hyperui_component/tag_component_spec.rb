...
RSpec.describe(HyperuiComponent::TagComponent, type: :component) do
  ...
  describe 'content' do
    ...
    context 'when content is supplied in a block' do
      ...
      subject! do
        render_inline(HyperuiComponent::TagComponent.new) do
    ...
    context 'when neither text or block content is supplied' do
      specify 'raises an appropriate error' do
        expect { render_inline(HyperuiComponent::TagComponent.new(colour: 'blue')) }.to raise_error(ArgumentError, /no text or content/)
      end
    end
  end
  ...
  describe 'colours' do
    context 'when valid colours are provided' do
      ...
      HyperuiComponent::TagComponent::COLOURS.each do |colour|
    ...
    context 'when invalid colours are provided' do
      ...
      subject { render_inline(HyperuiComponent::TagComponent.new(text: text, colour: invalid_colour)) }
