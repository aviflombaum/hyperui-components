...
RSpec.describe(HyperuiComponent::FooterComponent, type: :component) do
  ...
  describe 'configuration' do
    ...
    describe 'default footer component text and url' do
      ...
      subject! { render_inline(HyperuiComponent::FooterComponent.new(**kwargs)) }
    ...
    describe 'default_footer_meta_text' do
      ...
      subject! { render_inline(HyperuiComponent::FooterComponent.new(meta_text: overridden_default_text)) }
