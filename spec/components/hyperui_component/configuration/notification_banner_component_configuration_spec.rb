...
RSpec.describe(HyperuiComponent::NotificationBannerComponent, type: :component) do
  ...
  describe 'configuration' do
    ...
    describe 'default_notification_banner_title_id' do
      ...
      subject! { render_inline(HyperuiComponent::NotificationBannerComponent.new(**kwargs)) }
