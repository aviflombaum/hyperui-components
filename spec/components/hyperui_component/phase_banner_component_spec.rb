...
RSpec.describe(HyperuiComponent::PhaseBannerComponent, type: :component) do
  ...
  subject! { render_inline(HyperuiComponent::PhaseBannerComponent.new(**kwargs)) }
  ...
  context 'when content is supplied via a block' do
    ...
    subject! do
      render_inline(HyperuiComponent::PhaseBannerComponent.new(**kwargs.except(:text))) { content }
    end
