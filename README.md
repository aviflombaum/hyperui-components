...
* via the helper wrapper:
  ...
  The naming convention for helpers is `govuk_` followed by the component’s name in snake case. You can see the full list in [HyperuiComponentsHelper](app/helpers/govuk_components_helper.rb).
