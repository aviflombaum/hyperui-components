class HyperuiComponent::PaginationComponent < HyperuiComponent::Base
  ...
  renders_many :items, "HyperuiComponent::PaginationComponent::Item"

  renders_one :next_page, ->(href:, text: default_adjacent_text(:next), label_text: nil, classes: [], html_attributes: {}) do
    HyperuiComponent::PaginationComponent::NextPage.new(
      text: text,
      href: href,
  ...
  renders_one :previous_page, ->(href:, text: default_adjacent_text(:prev), label_text: nil, classes: [], html_attributes: {}) do
    HyperuiComponent::PaginationComponent::PreviousPage.new(
      text: text,
      href: href,
      label_text: label_text,
      block_mode: block_mode?,
