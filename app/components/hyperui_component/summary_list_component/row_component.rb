class HyperuiComponent::SummaryListComponent::RowComponent < HyperuiComponent::Base
  attr_reader :href, :visually_hidden_text, :show_actions_column

  renders_one :key, HyperuiComponent::SummaryListComponent::KeyComponent
  renders_one :value, HyperuiComponent::SummaryListComponent::ValueComponent
  renders_many :actions, HyperuiComponent::SummaryListComponent::ActionComponent
